...
// node_modules/.pnpm/@faker-js+faker@9.8.0/node_modules/@faker-js/faker/dist/chunk-KERBADJJ.js
...
// node_modules/.pnpm/@faker-js+faker@9.8.0/node_modules/@faker-js/faker/dist/chunk-PC2QB7VM.js
...
var O2 = class extends p2 {
  ...
  password(e2 = {}) {
    let r2 = /[aeiouAEIOU]$/, t2 = /[bcdfghjklmnpqrstvwxyzBCDFGHJKLMNPQRSTVWXYZ]$/, a2 = /* @__PURE__ */ __name((c2, u2, h2, f3) => {
    ...
    }, "a"), { length: n2 = 15, memorable: o2 = false, pattern: s2 = /\w/, prefix: l2 = "" } = e2;
...
var U2 = class extends p2 {
  ...
  fullName(e2 = {}) {
    ...
    return this.faker.helpers.mustache(n2, { "person.prefix": /* @__PURE__ */ __name(() => this.prefix(r2), "person.prefix"), "person.firstName": /* @__PURE__ */ __name(() => t2, "person.firstName"), "person.middleName": /* @__PURE__ */ __name(() => this.middleName(r2), "person.middleName"), "person.lastName": /* @__PURE__ */ __name(() => a2, "person.lastName"), "person.suffix": /* @__PURE__ */ __name(() => this.suffix(), "person.suffix") });
  }
  gender() {
...
var J2 = class extends x2 {
  ...
  nanoid(e2 = 21) {
    ...
    let r2 = [{ value: /* @__PURE__ */ __name(() => this.alphanumeric(1), "value"), weight: 62 }, { value: /* @__PURE__ */ __name(() => this.faker.helpers.arrayElement(["_", "-"]), "value"), weight: 2 }], t2 = "";
    for (; t2.length < e2; ) {
...
var $2 = class {
  ...
  _defaultRefDate = /* @__PURE__ */ __name(() => /* @__PURE__ */ new Date(), "_defaultRefDate");
  get defaultRefDate() {
...
__name(Ze2, "Ze");
var Me2 = { fail: /* @__PURE__ */ __name(() => {
  throw new m2("No words found that match the given length.");
}, "fail"), closest: /* @__PURE__ */ __name((i2, e2) => {
...
}, "closest"), shortest: /* @__PURE__ */ __name((i2) => {
  let e2 = Math.min(...i2.map((r2) => r2.length));
  return i2.filter((r2) => r2.length === e2);
}, "shortest"), longest: /* @__PURE__ */ __name((i2) => {
  let e2 = Math.max(...i2.map((r2) => r2.length));
  return i2.filter((r2) => r2.length === e2);
}, "longest"), "any-length": /* @__PURE__ */ __name((i2) => [...i2], "any-length") };
function T2(i2) {
...
// node_modules/.pnpm/@faker-js+faker@9.8.0/node_modules/@faker-js/faker/dist/chunk-TVFJBHBT.js
var f2 = new Xe2({ locale: [ys, Fi] });

// src/auth.ts
var auth = /* @__PURE__ */ __name(async (c2, next) => {
  ...
  c2.set("user", { id: 1, name: "Demo User" });
  await next();
}, "auth");
...
function generateFakeStats() {
  return Array.from({ length: 7 }, (_2, i2) => {
    ...
    const plants = plantTypes.map((plant) => ({
      ...
      harvested: f2.number.int({ min: 10, max: 200 }),
      height: f2.number.float({ min: 20, max: 150, fractionDigits: 1 }),
      growthRate: f2.number.float({ min: 0.5, max: 3, fractionDigits: 1 }),
      fertilizerUsed: f2.number.int({ min: 50, max: 300 }),
      waterUsed: f2.number.int({ min: 10, max: 100 }),
      soilMoisture: f2.number.int({ min: 30, max: 90 }),
      sunlightHours: f2.number.int({ min: 4, max: 12 }),
      pestTreatments: f2.number.int({ min: 0, max: 2 }),
      notes: f2.lorem.sentence()
    }));
    return { date, plants };
  }).reverse();
}
__name(generateFakeStats, "generateFakeStats");
app.get("/api/stats", auth, (c2) => {
...
app.post("/api/login", async (c2) => {
  ...
  if (username === "demo@demo.com" && password === "demo") {
    return c2.json({ token: "demo-token", user: { id: 1, name: "Admin" } });
  }
  return c2.json({ error: "Invalid credentials" }, 401);
});
var src_default = app;

// node_modules/.pnpm/wrangler@4.21.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// node_modules/.pnpm/wrangler@4.21.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-8yzIFb/middleware-insertion-facade.js
...
// node_modules/.pnpm/wrangler@4.21.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-8yzIFb/middleware-loader.entry.ts
